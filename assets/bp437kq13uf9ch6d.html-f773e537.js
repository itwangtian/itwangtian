import{_ as s}from"./plugin-vue_export-helper-c27b6911.js";import{r as a,o as l,c as d,a as e,b as i,d as n,e as r}from"./app-1bdccc93.js";const o={},c=r(`<p>eslint 检测代码规范、pretter 修复代码格式，他们功能有一些重叠，配置不当情况下、比如 eslint 设置单引号、prettier 双引号，会导致编译执行错误，导致冲突，如何解决呢？</p><p>冲突本质原因是 eslint 和 prettier 并行导致，解决冲突的方法好几种：</p><ol><li>关闭冲突规则</li><li>调整执行顺序</li><li>手动调整-统一配置</li></ol><h2 id="关闭冲突规则" tabindex="-1"><a class="header-anchor" href="#关闭冲突规则" aria-hidden="true">#</a> 关闭冲突规则</h2><p>使用 eslint-config-prettier 插件来禁用 ESLint 中与 Prettier 冲突的规则。<br> 该插件会将 Prettier 的规则应用到 ESLint 中，并自动禁用冲突的规则。您可以在 ESLint 配置文件中添加以下配置：</p><ol><li>安装 eslint-config-prettier：</li></ol><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm install --save-dev eslint-config-prettier
